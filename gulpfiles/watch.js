...
function watch() {
  ...
  gulp.watch([paths.src.html.files, paths.src.js.files, "./src/app/*.js", "./src/app/controllers/*/**.js", "./src/app/services/**.js"], gulp.series(fileInclude, browserSyncReload));
}
